...
builtinMethodSubsts = [
    ...
    , "3tr = dict:p: 32m:80% + lzp: 32m: 55:d1m:s16:h18:87% + ppmd:7:48m"    -- вариант -m3t с использованием ppmd вместе grzip(bwt)
    ...
    , "1b  = 1xb"
    , "2b  = 2xb"
    , "2br = delta + lzma:16m:fastest"
    , "3b  = 3xb"
    , "3br = rep:  32m + delta + lzma:  4m:fast:mc8"
    , "4b  = 4xb"
    , "4br = rep:  64m + delta + lzma:  8m:normal:mc16"
    , "5b  = rep: 128m + 5xb"
    , "6b  = rep: 256m + 6xb"
    , "7b  = rep: 512m + 7xb"
    , "8b  = rep:1024m + 8xb"
